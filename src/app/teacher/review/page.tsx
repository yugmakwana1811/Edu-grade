  ...
  return (
    <div className="page">
      <PageHeader
        ...
        title="Thoughtful feedback, faster"
        description="See handwritten pages, use AI for a starting suggestion, enter marks, edit feedback, and decide when the result is ready."
      />
      ...
      {submissions.length ? (
            ...
            <tbody>
              {submissions.map((s) => (
                <tr key={s.id}>
                  ...
                  <td>
                    {s.assignment.title}
                    <div className="hint">{s.assignment.class.name}</div>
                  </td>
                  ...
                  <td>
                    <Link
                      ...
                      aria-label={`Review ${s.student.user.name}`}
                    >
                      <ArrowRight size={17} />
                    </Link>
                  </td>
        ...
        <EmptyState
          ...
          description="Submitted student work will appear here automatically."
        />
      )}
    </div>
  );
